/****************************************************************************
 * vendor/rockchip/chips/rk3506/include/rk3506_sdmmc.h
 *
...
#ifndef __VENDOR_ROCKCHIP_CHIPS_RK3506_INCLUDE_RK3506_SDMMC_H
#define __VENDOR_ROCKCHIP_CHIPS_RK3506_INCLUDE_RK3506_SDMMC_H
...
#define RK3506_SDMMC_BASE                 0xff480000u

/* Linux describes this RK3506 instance with fifo-depth = <0x100>. */

#define RK3506_TXFIFO_DEPTH               256
#define RK3506_TXFIFO_WIDTH               4
#define RK3506_RXFIFO_DEPTH               256
#define RK3506_RXFIFO_WIDTH               4

/* MCI register offsets (with respect to the MCI base) **********************/

#define RK3506_SDMMC_CTRL_OFFSET          0x0000 /* Control register */
#define RK3506_SDMMC_PWREN_OFFSET         0x0004 /* Power Enable Register */
#define RK3506_SDMMC_CLKDIV_OFFSET        0x0008 /* Clock-divider register */
#define RK3506_SDMMC_CLKENA_OFFSET        0x0010 /* Clock-enable register */
#define RK3506_SDMMC_TMOUT_OFFSET         0x0014 /* Time-out register */
#define RK3506_SDMMC_CTYPE_OFFSET         0x0018 /* Card-type register */
#define RK3506_SDMMC_BLKSIZ_OFFSET        0x001c /* Block-size register */
#define RK3506_SDMMC_BYTCNT_OFFSET        0x0020 /* Byte-count register */
#define RK3506_SDMMC_INTMASK_OFFSET       0x0024 /* Interrupt-mask register */
#define RK3506_SDMMC_CMDARG_OFFSET        0x0028 /* Command-argument register */
#define RK3506_SDMMC_CMD_OFFSET           0x002c /* Command register */
#define RK3506_SDMMC_RESP0_OFFSET         0x0030 /* Response-0 register */
#define RK3506_SDMMC_RESP1_OFFSET         0x0034 /* Response-1 register */
#define RK3506_SDMMC_RESP2_OFFSET         0x0038 /* Response-2 register */
#define RK3506_SDMMC_RESP3_OFFSET         0x003c /* Response-3 register */
#define RK3506_SDMMC_MINTSTS_OFFSET       0x0040 /* Masked interrupt-status register */
#define RK3506_SDMMC_RINTSTS_OFFSET       0x0044 /* Raw interrupt-status register */
#define RK3506_SDMMC_STATUS_OFFSET        0x0048 /* Status register */
#define RK3506_SDMMC_FIFOTH_OFFSET        0x004c /* FIFO threshold register */
#define RK3506_SDMMC_CDETECT_OFFSET       0x0050 /* Card-detect register value */
#define RK3506_SDMMC_WRTPRT_OFFSET        0x0054 /* Write-protect register */
#define RK3506_SDMMC_TCBCNT_OFFSET        0x005c /* Transferred CIU card byte count */
#define RK3506_SDMMC_TBBCNT_OFFSET        0x0060 /* Transferred host to BIU-FIFO byte count */
#define RK3506_SDMMC_DEBNCE_OFFSET        0x0064 /* Debounce count register */
#define RK3506_SDMMC_RSTN_OFFSET          0x0078 /* Hardware Reset */
#define RK3506_SDMMC_BMOD_OFFSET          0x0080 /* Bus Mode Register */
#define RK3506_SDMMC_PLDMND_OFFSET        0x0084 /* Poll Demand Register */
#define RK3506_SDMMC_DBADDR_OFFSET        0x0088 /* Descriptor List Base Address Register */
#define RK3506_SDMMC_IDSTS_OFFSET         0x008c /* Internal DMAC Status Register */
#define RK3506_SDMMC_IDINTEN_OFFSET       0x0090 /* Internal DMAC Interrupt Enable Register */
#define RK3506_SDMMC_DSCADDR_OFFSET       0x0094 /* Current Host Descriptor Address Register */
#define RK3506_SDMMC_BUFADDR_OFFSET       0x0098 /* Current Buffer Descriptor Address Register */
#define RK3506_SDMMC_CARDTHRCTL_OFFSET    0x0100 /* Card threshold control */
#define RK3506_SDMMC_BACKENDPWRL_OFFSET   0x0104 /* Power control */

#define RK3506_SDMMC_DATA_OFFSET          0x0200 /* Data FIFO read/write (>=) */

/* MCI register (virtual) addresses *****************************************/

#define RK3506_SDMMC_CTRL                 (RK3506_SDMMC_BASE + RK3506_SDMMC_CTRL_OFFSET)
#define RK3506_SDMMC_PWREN                (RK3506_SDMMC_BASE + RK3506_SDMMC_PWREN_OFFSET)
#define RK3506_SDMMC_CLKDIV               (RK3506_SDMMC_BASE + RK3506_SDMMC_CLKDIV_OFFSET)
#define RK3506_SDMMC_CLKENA               (RK3506_SDMMC_BASE + RK3506_SDMMC_CLKENA_OFFSET)
#define RK3506_SDMMC_TMOUT                (RK3506_SDMMC_BASE + RK3506_SDMMC_TMOUT_OFFSET)
#define RK3506_SDMMC_CTYPE                (RK3506_SDMMC_BASE + RK3506_SDMMC_CTYPE_OFFSET)
#define RK3506_SDMMC_BLKSIZ               (RK3506_SDMMC_BASE + RK3506_SDMMC_BLKSIZ_OFFSET)
#define RK3506_SDMMC_BYTCNT               (RK3506_SDMMC_BASE + RK3506_SDMMC_BYTCNT_OFFSET)
#define RK3506_SDMMC_INTMASK              (RK3506_SDMMC_BASE + RK3506_SDMMC_INTMASK_OFFSET)
#define RK3506_SDMMC_CMDARG               (RK3506_SDMMC_BASE + RK3506_SDMMC_CMDARG_OFFSET)
#define RK3506_SDMMC_CMD                  (RK3506_SDMMC_BASE + RK3506_SDMMC_CMD_OFFSET)
#define RK3506_SDMMC_RESP0                (RK3506_SDMMC_BASE + RK3506_SDMMC_RESP0_OFFSET)
#define RK3506_SDMMC_RESP1                (RK3506_SDMMC_BASE + RK3506_SDMMC_RESP1_OFFSET)
#define RK3506_SDMMC_RESP2                (RK3506_SDMMC_BASE + RK3506_SDMMC_RESP2_OFFSET)
#define RK3506_SDMMC_RESP3                (RK3506_SDMMC_BASE + RK3506_SDMMC_RESP3_OFFSET)
#define RK3506_SDMMC_MINTSTS              (RK3506_SDMMC_BASE + RK3506_SDMMC_MINTSTS_OFFSET)
#define RK3506_SDMMC_RINTSTS              (RK3506_SDMMC_BASE + RK3506_SDMMC_RINTSTS_OFFSET)
#define RK3506_SDMMC_STATUS               (RK3506_SDMMC_BASE + RK3506_SDMMC_STATUS_OFFSET)
#define RK3506_SDMMC_FIFOTH               (RK3506_SDMMC_BASE + RK3506_SDMMC_FIFOTH_OFFSET)
#define RK3506_SDMMC_CDETECT              (RK3506_SDMMC_BASE + RK3506_SDMMC_CDETECT_OFFSET)
#define RK3506_SDMMC_WRTPRT               (RK3506_SDMMC_BASE + RK3506_SDMMC_WRTPRT_OFFSET)
#define RK3506_SDMMC_TCBCNT               (RK3506_SDMMC_BASE + RK3506_SDMMC_TCBCNT_OFFSET)
#define RK3506_SDMMC_TBBCNT               (RK3506_SDMMC_BASE + RK3506_SDMMC_TBBCNT_OFFSET)
#define RK3506_SDMMC_TBBCNT               (RK3506_SDMMC_BASE + RK3506_SDMMC_TBBCNT_OFFSET)
#define RK3506_SDMMC_DEBNCE               (RK3506_SDMMC_BASE + RK3506_SDMMC_DEBNCE_OFFSET)
#define RK3506_SDMMC_RSTN                 (RK3506_SDMMC_BASE + RK3506_SDMMC_RSTN_OFFSET)
#define RK3506_SDMMC_BMOD                 (RK3506_SDMMC_BASE + RK3506_SDMMC_BMOD_OFFSET)
#define RK3506_SDMMC_PLDMND               (RK3506_SDMMC_BASE + RK3506_SDMMC_PLDMND_OFFSET)
#define RK3506_SDMMC_DBADDR               (RK3506_SDMMC_BASE + RK3506_SDMMC_DBADDR_OFFSET)
#define RK3506_SDMMC_IDSTS                (RK3506_SDMMC_BASE + RK3506_SDMMC_IDSTS_OFFSET)
#define RK3506_SDMMC_IDINTEN              (RK3506_SDMMC_BASE + RK3506_SDMMC_IDINTEN_OFFSET)
#define RK3506_SDMMC_DSCADDR              (RK3506_SDMMC_BASE + RK3506_SDMMC_DSCADDR_OFFSET)
#define RK3506_SDMMC_BUFADDR              (RK3506_SDMMC_BASE + RK3506_SDMMC_BUFADDR_OFFSET)
#define RK3506_SDMMC_CARDTHRCTL           (RK3506_SDMMC_BASE + RK3506_SDMMC_CARDTHRCTL_OFFSET)
#define RK3506_SDMMC_BACKENDPWRL          (RK3506_SDMMC_BASE + RK3506_SDMMC_BACKENDPWRL_OFFSET)

#define RK3506_SDMMC_DATA                 (RK3506_SDMMC_BASE + RK3506_SDMMC_DATA_OFFSET)
...
#define SDMMC_CTRL_DMAENABLE             (1 << 5)  /* Bit 5:  Enable DMA transfer interface */
...
#endif /* __VENDOR_ROCKCHIP_CHIPS_RK3506_INCLUDE_RK3506_SDMMC_H */
