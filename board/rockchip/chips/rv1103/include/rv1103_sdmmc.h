/****************************************************************************
 * vendor/rockchip/chips/rv1103/include/rv1103_sdmmc.h
 *
...
#ifndef __VENDOR_ROCKCHIP_CHIPS_RV1103_INCLUDE_RV1103_SDMMC_H
#define __VENDOR_ROCKCHIP_CHIPS_RV1103_INCLUDE_RV1103_SDMMC_H
...
#define RV1103_SDMMC_BASE                 0xffaa0000u

/* Linux describes this RV1103 instance with fifo-depth = <0x100>. */

#define RV1103_TXFIFO_DEPTH               256
#define RV1103_TXFIFO_WIDTH               4
#define RV1103_RXFIFO_DEPTH               256
#define RV1103_RXFIFO_WIDTH               4

/* MCI register offsets (with respect to the MCI base) **********************/

#define RV1103_SDMMC_CTRL_OFFSET          0x0000 /* Control register */
#define RV1103_SDMMC_PWREN_OFFSET         0x0004 /* Power Enable Register */
#define RV1103_SDMMC_CLKDIV_OFFSET        0x0008 /* Clock-divider register */
#define RV1103_SDMMC_CLKENA_OFFSET        0x0010 /* Clock-enable register */
#define RV1103_SDMMC_TMOUT_OFFSET         0x0014 /* Time-out register */
#define RV1103_SDMMC_CTYPE_OFFSET         0x0018 /* Card-type register */
#define RV1103_SDMMC_BLKSIZ_OFFSET        0x001c /* Block-size register */
#define RV1103_SDMMC_BYTCNT_OFFSET        0x0020 /* Byte-count register */
#define RV1103_SDMMC_INTMASK_OFFSET       0x0024 /* Interrupt-mask register */
#define RV1103_SDMMC_CMDARG_OFFSET        0x0028 /* Command-argument register */
#define RV1103_SDMMC_CMD_OFFSET           0x002c /* Command register */
#define RV1103_SDMMC_RESP0_OFFSET         0x0030 /* Response-0 register */
#define RV1103_SDMMC_RESP1_OFFSET         0x0034 /* Response-1 register */
#define RV1103_SDMMC_RESP2_OFFSET         0x0038 /* Response-2 register */
#define RV1103_SDMMC_RESP3_OFFSET         0x003c /* Response-3 register */
#define RV1103_SDMMC_MINTSTS_OFFSET       0x0040 /* Masked interrupt-status register */
#define RV1103_SDMMC_RINTSTS_OFFSET       0x0044 /* Raw interrupt-status register */
#define RV1103_SDMMC_STATUS_OFFSET        0x0048 /* Status register */
#define RV1103_SDMMC_FIFOTH_OFFSET        0x004c /* FIFO threshold register */
#define RV1103_SDMMC_CDETECT_OFFSET       0x0050 /* Card-detect register value */
#define RV1103_SDMMC_WRTPRT_OFFSET        0x0054 /* Write-protect register */
#define RV1103_SDMMC_TCBCNT_OFFSET        0x005c /* Transferred CIU card byte count */
#define RV1103_SDMMC_TBBCNT_OFFSET        0x0060 /* Transferred host to BIU-FIFO byte count */
#define RV1103_SDMMC_DEBNCE_OFFSET        0x0064 /* Debounce count register */
#define RV1103_SDMMC_RSTN_OFFSET          0x0078 /* Hardware Reset */
#define RV1103_SDMMC_BMOD_OFFSET          0x0080 /* Bus Mode Register */
#define RV1103_SDMMC_PLDMND_OFFSET        0x0084 /* Poll Demand Register */
#define RV1103_SDMMC_DBADDR_OFFSET        0x0088 /* Descriptor List Base Address Register */
#define RV1103_SDMMC_IDSTS_OFFSET         0x008c /* Internal DMAC Status Register */
#define RV1103_SDMMC_IDINTEN_OFFSET       0x0090 /* Internal DMAC Interrupt Enable Register */
#define RV1103_SDMMC_DSCADDR_OFFSET       0x0094 /* Current Host Descriptor Address Register */
#define RV1103_SDMMC_BUFADDR_OFFSET       0x0098 /* Current Buffer Descriptor Address Register */
#define RV1103_SDMMC_CARDTHRCTL_OFFSET    0x0100 /* Card threshold control */
#define RV1103_SDMMC_BACKENDPWRL_OFFSET   0x0104 /* Power control */

#define RV1103_SDMMC_DATA_OFFSET          0x0200 /* Data FIFO read/write (>=) */

/* MCI register (virtual) addresses *****************************************/

#define RV1103_SDMMC_CTRL                 (RV1103_SDMMC_BASE + RV1103_SDMMC_CTRL_OFFSET)
#define RV1103_SDMMC_PWREN                (RV1103_SDMMC_BASE + RV1103_SDMMC_PWREN_OFFSET)
#define RV1103_SDMMC_CLKDIV               (RV1103_SDMMC_BASE + RV1103_SDMMC_CLKDIV_OFFSET)
#define RV1103_SDMMC_CLKENA               (RV1103_SDMMC_BASE + RV1103_SDMMC_CLKENA_OFFSET)
#define RV1103_SDMMC_TMOUT                (RV1103_SDMMC_BASE + RV1103_SDMMC_TMOUT_OFFSET)
#define RV1103_SDMMC_CTYPE                (RV1103_SDMMC_BASE + RV1103_SDMMC_CTYPE_OFFSET)
#define RV1103_SDMMC_BLKSIZ               (RV1103_SDMMC_BASE + RV1103_SDMMC_BLKSIZ_OFFSET)
#define RV1103_SDMMC_BYTCNT               (RV1103_SDMMC_BASE + RV1103_SDMMC_BYTCNT_OFFSET)
#define RV1103_SDMMC_INTMASK              (RV1103_SDMMC_BASE + RV1103_SDMMC_INTMASK_OFFSET)
#define RV1103_SDMMC_CMDARG               (RV1103_SDMMC_BASE + RV1103_SDMMC_CMDARG_OFFSET)
#define RV1103_SDMMC_CMD                  (RV1103_SDMMC_BASE + RV1103_SDMMC_CMD_OFFSET)
#define RV1103_SDMMC_RESP0                (RV1103_SDMMC_BASE + RV1103_SDMMC_RESP0_OFFSET)
#define RV1103_SDMMC_RESP1                (RV1103_SDMMC_BASE + RV1103_SDMMC_RESP1_OFFSET)
#define RV1103_SDMMC_RESP2                (RV1103_SDMMC_BASE + RV1103_SDMMC_RESP2_OFFSET)
#define RV1103_SDMMC_RESP3                (RV1103_SDMMC_BASE + RV1103_SDMMC_RESP3_OFFSET)
#define RV1103_SDMMC_MINTSTS              (RV1103_SDMMC_BASE + RV1103_SDMMC_MINTSTS_OFFSET)
#define RV1103_SDMMC_RINTSTS              (RV1103_SDMMC_BASE + RV1103_SDMMC_RINTSTS_OFFSET)
#define RV1103_SDMMC_STATUS               (RV1103_SDMMC_BASE + RV1103_SDMMC_STATUS_OFFSET)
#define RV1103_SDMMC_FIFOTH               (RV1103_SDMMC_BASE + RV1103_SDMMC_FIFOTH_OFFSET)
#define RV1103_SDMMC_CDETECT              (RV1103_SDMMC_BASE + RV1103_SDMMC_CDETECT_OFFSET)
#define RV1103_SDMMC_WRTPRT               (RV1103_SDMMC_BASE + RV1103_SDMMC_WRTPRT_OFFSET)
#define RV1103_SDMMC_TCBCNT               (RV1103_SDMMC_BASE + RV1103_SDMMC_TCBCNT_OFFSET)
#define RV1103_SDMMC_TBBCNT               (RV1103_SDMMC_BASE + RV1103_SDMMC_TBBCNT_OFFSET)
#define RV1103_SDMMC_TBBCNT               (RV1103_SDMMC_BASE + RV1103_SDMMC_TBBCNT_OFFSET)
#define RV1103_SDMMC_DEBNCE               (RV1103_SDMMC_BASE + RV1103_SDMMC_DEBNCE_OFFSET)
#define RV1103_SDMMC_RSTN                 (RV1103_SDMMC_BASE + RV1103_SDMMC_RSTN_OFFSET)
#define RV1103_SDMMC_BMOD                 (RV1103_SDMMC_BASE + RV1103_SDMMC_BMOD_OFFSET)
#define RV1103_SDMMC_PLDMND               (RV1103_SDMMC_BASE + RV1103_SDMMC_PLDMND_OFFSET)
#define RV1103_SDMMC_DBADDR               (RV1103_SDMMC_BASE + RV1103_SDMMC_DBADDR_OFFSET)
#define RV1103_SDMMC_IDSTS                (RV1103_SDMMC_BASE + RV1103_SDMMC_IDSTS_OFFSET)
#define RV1103_SDMMC_IDINTEN              (RV1103_SDMMC_BASE + RV1103_SDMMC_IDINTEN_OFFSET)
#define RV1103_SDMMC_DSCADDR              (RV1103_SDMMC_BASE + RV1103_SDMMC_DSCADDR_OFFSET)
#define RV1103_SDMMC_BUFADDR              (RV1103_SDMMC_BASE + RV1103_SDMMC_BUFADDR_OFFSET)
#define RV1103_SDMMC_CARDTHRCTL           (RV1103_SDMMC_BASE + RV1103_SDMMC_CARDTHRCTL_OFFSET)
#define RV1103_SDMMC_BACKENDPWRL          (RV1103_SDMMC_BASE + RV1103_SDMMC_BACKENDPWRL_OFFSET)

#define RV1103_SDMMC_DATA                 (RV1103_SDMMC_BASE + RV1103_SDMMC_DATA_OFFSET)
...
#endif /* __VENDOR_ROCKCHIP_CHIPS_RV1103_INCLUDE_RV1103_SDMMC_H */
